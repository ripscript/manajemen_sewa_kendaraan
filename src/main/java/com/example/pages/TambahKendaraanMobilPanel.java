 ...
 * @author ripsc
 */
public class TambahKendaraanMobilPanel extends javax.swing.JPanel {
     ...
     */
    public TambahKendaraanMobilPanel(HomeAdminFrame homeAdminFrame) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Tambah Kendaraan Mobil");
    ...
    private void buttonKembaliActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonKembaliActionPerformed
        MobilAdminPanel mobilAdminPanel = new MobilAdminPanel(homeAdminFrame);
        
        if (homeAdminFrame != null) {
            homeAdminFrame.changeMainContent(mobilAdminPanel);
        }
