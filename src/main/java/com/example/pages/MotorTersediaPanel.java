 ...
 * @author ripsc
 */
public class MotorTersediaPanel extends javax.swing.JPanel {
     ...
     */
    public MotorTersediaPanel(HomePelangganFrame homePelangganFrame) {
        
        daftarMotor = vehicleService.getMotorAvailableVehicles();
        ...
        dataTable.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (col == 3 && row >= 0) {
                    ...
                    SewaKendaraanMotorPanel sewaKendaraanMotorPanel = new SewaKendaraanMotorPanel(homePelangganFrame, id);
        
                    if (homePelangganFrame != null) {
                        homePelangganFrame.changeMainContent(sewaKendaraanMotorPanel);
                    }
                }
            }
        });
