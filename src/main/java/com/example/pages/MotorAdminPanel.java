 ...
 * @author ripsc
 */
public class MotorAdminPanel extends javax.swing.JPanel {
    private HomeAdminFrame homeFrame;
    private DefaultTableModel tableModel;
    private JTableHeader tableHeader;
    private final VehicleService vehicleService = new VehicleService();
    private List<Vehicle> daftarMotor; 

    /**
     * Creates new form MotorAdminPanel
     */
    public MotorAdminPanel(HomeAdminFrame homeFrame) {
        
        daftarMotor = vehicleService.getMotorVehicles();
        
        String[] columnNames = {"Pilih", "No", "Brand", "Plat Nomor", "Status", "Aksi"};
        Object[][] data = new Object[daftarMotor.size()][columnNames.length];
        for (int i = 0; i < daftarMotor.size(); i++) {
            Vehicle vehicle = daftarMotor.get(i);
            data[i][0] = false;
        ...
        dataTable.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (col == 5 && row >= 0) {
                    ...
                    int id = daftarMotor.get(row).getId();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Daftar Kendaraan Motor Yang Tersedia");
    ...
    private void hapusBarisPilihanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_hapusBarisPilihanActionPerformed
        ...
        for (int i = 0; i < tableModel.getRowCount(); i++) {
            ...
            if (isSelected != null && isSelected) {
                ...
                int vehicleId = daftarMotor.get(i).getId(); // Ambil ID kendaraan
        ...
        if (confirm == JOptionPane.YES_OPTION) {
            ...
            if (isDeleted) {
                ...
                daftarMotor.removeIf(vehicle -> vehicleIdsToDelete.contains(((Vehicle) vehicle).getId()));
    ...
    private void buttonShowFormTambahKendaraanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonShowFormTambahKendaraanActionPerformed
        TambahKendaraanMotorPanel tambahKendaraanMotorPanel = new TambahKendaraanMotorPanel(homeFrame);
        
        if (homeFrame != null) {
            homeFrame.changeMainContent(tambahKendaraanMotorPanel);
        } else {
