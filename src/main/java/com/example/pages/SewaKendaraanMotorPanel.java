 ...
 * @author ripsc
 */
public class SewaKendaraanMotorPanel extends javax.swing.JPanel {
     ...
     */
    public SewaKendaraanMotorPanel(HomePelangganFrame homePelangganFrame, int vehicleId) {
...
//        });
    ...
    private void buttonKembaliActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonKembaliActionPerformed
        homePelangganFrame.changeMainContent(new MotorTersediaPanel(homePelangganFrame));
